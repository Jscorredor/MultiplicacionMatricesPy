...
class III5EnhancedParallelBlock:
    def __init__(self):
        self.nombreMetodo = "III5EnhancedParallelBlock"

    def algoritmo(self, matriz):
        return self.alg_III_5_Enhanced_Parallel_Block(matriz)

    def alg_III_5_Enhanced_Parallel_Block(self, matriz):
        size = len(matriz)
...
if __name__ == "__main__":
    ...
    algoritmo = III5EnhancedParallelBlock()
